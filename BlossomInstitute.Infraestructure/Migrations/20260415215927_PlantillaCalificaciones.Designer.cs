...
namespace BlossomInstitute.Infraestructure.Migrations
{
    ...
    [Migration("20260415215927_PlantillaCalificaciones")]
    partial class PlantillaCalificaciones
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlossomInstitute.Domain.Entidades.Calificacion.CalificacionDetalleEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CalificacionId", "Skill")
                        .IsUnique();
            ...
            modelBuilder.Entity("BlossomInstitute.Domain.Entidades.Calificaciones.CalificacionEntity", b =>
                {
                    ...
                    b.Property<bool>("TieneDetalleSkills")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("CursoId", "AlumnoId", "Archivado");

                    b.HasIndex("CursoId", "AlumnoId", "Fecha");

                    b.HasIndex("CursoId", "AlumnoId", "Tipo", "Archivado");

                    b.HasIndex("CursoId", "AlumnoId", "TareaId", "EntregaId", "Archivado")
                        .IsUnique();
            ...
            modelBuilder.Entity("BlossomInstitute.Domain.Entidades.Calificacion.CalificacionDetalleEntity", b =>
                {
                    b.HasOne("BlossomInstitute.Domain.Entidades.Calificaciones.CalificacionEntity", "Calificacion")
                        .WithMany("Detalles")
            ...
            modelBuilder.Entity("BlossomInstitute.Domain.Entidades.Profesor.ProfesorEntity", b =>
                {
                    b.HasOne("BlossomInstitute.Domain.Entidades.Usuario.UsuarioEntity", "Usuario")
                        .WithOne("Profesor")
                        .HasForeignKey("BlossomInstitute.Domain.Entidades.Profesor.ProfesorEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("BlossomInstitute.Domain.Entidades.Usuario.UsuarioEntity", null)
                        .WithMany()
